...
content = open("/root/projects/SEprojecct/input files/webpage_ip.txt", "w")
content.write(check_response(resp))
content.close()

with open("/root/projects/SEprojecct/input files/webpage_ip.txt") as webpage:
...
valid = open("/root/projects/SEprojecct/output files/valid-ip.txt","w")
invalid = open("/root/projects/SEprojecct/output files/invalid-ip.txt","w")
